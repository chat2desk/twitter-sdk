defmodule TwitterApiClient.Model.Tweet do
  @moduledoc """
  Tweet object.
...
defmodule TwitterApiClient.Model.Upload do
  defstruct expires_after_secs: nil,  media_id: nil, media_id_string: nil, size: nil
  @type t :: %__MODULE__{}
end


defmodule TwitterApiClient.Model.User do
  @moduledoc """
  User object.
...
defmodule TwitterApiClient.Model.DirectMessage do
...
defmodule TwitterApiClient.Model.Entities do
  @moduledoc """
  Entities object.
...
defmodule TwitterApiClient.Model.Trend do
  defstruct events: nil, name: nil, promoted_content: nil, query: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.List do
...
defmodule TwitterApiClient.Model.Place do
  @moduledoc """
  Place object.
...
defmodule TwitterApiClient.Model.Geo do
  defstruct type: nil, coordinates: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.DeletedTweet do
  defstruct status: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.Limit do
  defstruct track: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.StallWarning do
  defstruct code: nil, message: nil, percent_full: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.Cursor do
  defstruct items: nil, next_cursor: nil, previous_cursor: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.RequestToken do
  defstruct oauth_token: nil, oauth_token_secret: nil, oauth_callback_confirmed: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.AccessToken do
  defstruct oauth_token: nil, oauth_token_secret: nil, user_id: nil, screen_name: nil

  @type t :: %__MODULE__{}
end

defmodule TwitterApiClient.Model.SearchResponse do
